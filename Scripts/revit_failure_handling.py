...
def ReportFailureWarning(failure, failureDefinition, output):
    ...
    output()
    output("\t" + str(failureSeverity) + " - " + failure.GetDescriptionText() + " - " + "(" + "GUID: " +
    ...
    try:
        ...
        if failures.Any():
            ...
            for failure in failures:
                ...
                if failureSeverity == FailureSeverity.Warning and not rollBackOnWarning:
                ...
                elif (failureSeverity == FailureSeverity.Error and failure.HasResolutions()
                    ...
                    if failure.HasResolutionOfType(FailureResolutionType.UnlockConstraints):
                        ...
                        output()
                        output("\t" + "WARNING: UnlockConstraints is not a valid resolution for this "
                                      "failure despite the definition reporting that it is an applicable resolution!")
                    output()
