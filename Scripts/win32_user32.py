...
def GetWindowText(hwnd):
    ...
    default = System.Text.Encoding.GetEncoding(1251)
    numberOfChars = Win32_GetWindowText(hwnd, s, STRING_BUFFER_SIZE)
    bytesArray = System.Text.Encoding.Convert(encoding, default, encoding.GetBytes(s.ToString()))
    result = encoding.GetString(bytesArray)
    return s.ToString()
